var store = [{
        ...
        "title": "전송계층",
        "excerpt":"전송 계층의 역할   목적지에 신뢰할 수 있는 데이터를 전달하기 위해 필요한 계층   전송 계층     오류를 점검하는 기능   전송된 데이터의 목적지가 어떤 애플리케이션인지 식별하는 기능   연결형 통신과 비연결형 통신  전송 계층의 특징은 신뢰성/정확성과 효울성으로 구분할 수 있다.       연결형 통신 : 신뢰할 수 있고 정확한 데이터를 전달하는 통신   비연결형 통신 :  ","categories": ["Network"],
        "tags": ["tag1","tag2"],
